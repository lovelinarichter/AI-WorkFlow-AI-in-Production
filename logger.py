...
if __name__ == "__main__":
    ...
    ## train logger
    update_train_log(str((100,10)),"{'rmse':0.5}","00:00:01","00:00:01", MODEL_VERSION, MODEL_VERSION_NOTE, test=True)
    ## predict logger
    update_predict_log("[0]","[0.6,0.4]","['united_states', 24, 'aavail_basic', 8]","00:00:01","00:00:01",MODEL_VERSION, test=True)
